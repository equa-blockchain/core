...
// invoked by the go-equa core at various points in the state transition.
//
// To create a tracer that can be invoked with Geth, you need to register it using
// [github.com/equa/go-equa/eth/tracers.LiveDirectory.Register].
//
// See https://geth.equa.org/docs/developers/evm-tracing/live-tracing for a tutorial.
package tracing
