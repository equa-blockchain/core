...
import (
	...
	"github.com/equa/go-equa/common/bitutil"
	"github.com/equa/go-equa/core/tracing"
	"github.com/equa/go-equa/crypto"
	"github.com/equa/go-equa/crypto/blake2b"
	"github.com/equa/go-equa/crypto/bn256"
	"github.com/equa/go-equa/crypto/kzg4844"
	"github.com/equa/go-equa/crypto/secp256r1"
...
func (c *bigModExp) RequiredGas(input []byte) uint64 {
	...
	if c.eip2565 {
		...
		// in EIP-2565 (https://eips.equa.org/EIPS/eip-2565):
		//
		// def mult_complexity(x):
		//    ceiling(x/8)^2
		//
