// Copyright 2019 The go-equa Authors
...
import (
	...
	"github.com/equa/go-equa/accounts/abi/bind/v2"
...
func (mt *mockTransactor) EstimateGas(ctx context.Context, call equa.CallMsg) (gas uint64, err error) {
	return 0, nil
}
...
func (mc *mockCaller) CallContract(ctx context.Context, call equa.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (mc *mockPendingCaller) PendingCallContract(ctx context.Context, call equa.CallMsg) ([]byte, error) {
...
func (mc *mockBlockHashCaller) CallContractAtHash(ctx context.Context, call equa.CallMsg, hash common.Hash) ([]byte, error) {
