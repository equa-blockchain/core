...
type ContractCaller interface {
	...
	// input.
	CallContract(ctx context.Context, call equa.CallMsg, blockNumber *big.Int) ([]byte, error)
}
...
type PendingContractCaller interface {
	...
	PendingCallContract(ctx context.Context, call equa.CallMsg) ([]byte, error)
}
...
type BlockHashContractCaller interface {
	...
	CallContractAtHash(ctx context.Context, call equa.CallMsg, blockHash common.Hash) ([]byte, error)
}
