...
func (ec *Client) TransactionByHash(ctx context.Context, hash common.Hash) (tx *types.Transaction, isPending bool, err error) {
	...
	if err != nil {
		...
		return nil, false, equa.NotFound
...
func (ec *Client) SyncProgress(ctx context.Context) (*equa.SyncProgress, error) {
	var raw json.RawMessage
...
func (ec *Client) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (equa.Subscription, error) {
...
func (ec *Client) FilterLogs(ctx context.Context, q equa.FilterQuery) ([]types.Log, error) {
...
func (ec *Client) SubscribeFilterLogs(ctx context.Context, q equa.FilterQuery, ch chan<- types.Log) (equa.Subscription, error) {
	arg, err := toFilterArg(q)
	if err != nil {
		return nil, err
	}
...
func toFilterArg(q equa.FilterQuery) (interface{}, error) {
...
func (ec *Client) CallContract(ctx context.Context, msg equa.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (ec *Client) CallContractAtHash(ctx context.Context, msg equa.CallMsg, blockHash common.Hash) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) PendingCallContract(ctx context.Context, msg equa.CallMsg) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) FeeHistory(ctx context.Context, blockCount uint64, lastBlock *big.Int, rewardPercentiles []float64) (*equa.FeeHistory, error) {
...
// state.
func (ec *Client) EstimateGas(ctx context.Context, msg equa.CallMsg) (uint64, error) {
...
func (ec *Client) EstimateGasAtBlock(ctx context.Context, msg equa.CallMsg, blockNumber *big.Int) (uint64, error) {
	var hex hexutil.Uint64
...
func (ec *Client) EstimateGasAtBlockHash(ctx context.Context, msg equa.CallMsg, blockHash common.Hash) (uint64, error) {
	var hex hexutil.Uint64
...
func toCallArg(msg equa.CallMsg) interface{} {
	arg := map[string]interface{}{
		"from": msg.From,
		"to":   msg.To,
	}
...
func (p *rpcProgress) toSyncProgress() *equa.SyncProgress {
	if p == nil {
		return nil
	}
	return &equa.SyncProgress{
