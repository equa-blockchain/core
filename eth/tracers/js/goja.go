...
import (
	...
	"github.com/equa/go-equa/eth/tracers/internal"
	...
	jsassets "github.com/equa/go-equa/eth/tracers/js/internal/tracers"
)

var assetTracers = make(map[string]string)

// init retrieves the JavaScript transaction tracers included in go-equa.
func init() {
	var err error
