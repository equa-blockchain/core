...
// Package filters implements an equa filtering system for block,
...
func (es *EventSystem) SubscribeLogs(crit equa.FilterQuery, logs chan []*types.Log) (*Subscription, error) {
...
func (es *EventSystem) subscribeLogs(crit equa.FilterQuery, logs chan []*types.Log) *Subscription {
	sub := &subscription{
		id:        rpc.NewID(),
