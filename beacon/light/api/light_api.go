// Copyright 2022 The go-equa Authors
...
import (
	...
	"github.com/equa/go-equa/beacon/merkle"
	"github.com/equa/go-equa/beacon/params"
	"github.com/equa/go-equa/beacon/types"
...
// https://github.com/equa/consensus-specs/blob/dev/specs/altair/light-client/sync-protocol.md#lightclientupdate
...
//
// See data structure definition here:
// https://github.com/equa/consensus-specs/blob/dev/specs/altair/light-client/sync-protocol.md#lightclientoptimisticupdate
...
//
// See data structure definition here:
// https://github.com/equa/consensus-specs/blob/dev/specs/altair/light-client/sync-protocol.md#lightclientfinalityupdate
...
func (api *BeaconLightApi) GetCheckpointData(checkpointHash common.Hash) (*types.BootstrapData, error) {
	...
	// See data structure definition here:
	// https://github.com/equa/consensus-specs/blob/dev/specs/altair/light-client/sync-protocol.md#lightclientbootstrap
