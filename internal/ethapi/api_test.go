...
import (
	...
	"github.com/equa/go-equa/internal/blocktest"
	"github.com/equa/go-equa/internal/ethapi/override"
...
func (b testBackend) SyncProgress(ctx context.Context) equa.SyncProgress {
